...
> Production status as of the current audit: email is not active. Database delivery records show `provider_not_configured`; do not invite real users until the acceptance test below succeeds from the deployed application.
